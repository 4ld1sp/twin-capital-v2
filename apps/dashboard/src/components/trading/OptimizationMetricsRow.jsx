...
const OptimizationMetricsRow = () => {
  return (
    <div className="grid grid-cols-3 gap-6">
      <div className="glass-card rounded-2xl p-6 shadow-sm border border-glass transition-all duration-300">
        <p className="text-[10px] text-secondary font-black uppercase tracking-widest mb-1.5 pl-1">Total Return</p>
      ...
      <div className="glass-card rounded-2xl p-6 shadow-sm border border-glass transition-all duration-300">
        <p className="text-[10px] text-secondary font-black uppercase tracking-widest mb-1.5 pl-1">Sharpe Ratio</p>
        <p className="text-2xl font-black text-main">2.84</p>
        <p className="text-[9px] text-secondary/60 font-black uppercase tracking-widest mt-2 pl-1">Industrial Benchmark: 1.5</p>
      </div>
      <div className="glass-card rounded-2xl p-6 shadow-sm border border-glass transition-all duration-300">
        <p className="text-[10px] text-secondary font-black uppercase tracking-widest mb-1.5 pl-1">Max Drawdown</p>
