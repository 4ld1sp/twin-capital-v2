        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-glass">
            <tr className="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
              ...
              <td className="px-8 py-5"><span className="bg-primary/20 text-primary px-3 py-1 rounded-lg font-black text-[10px] uppercase tracking-widest border border-primary/30">+201.7%</span></td>
            </tr>
            <tr className="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
            ...
            <tr className="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
              ...
              <td className="px-8 py-5"><span className="bg-rose-500/10 text-rose-500 px-3 py-1 rounded-lg font-black text-[10px] uppercase tracking-widest border border-rose-500/30">-54.5%</span></td>
            </tr>
            <tr className="hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
