...
const BacktestsQuickActions = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      <div className="p-8 rounded-3xl border border-primary/30 bg-primary/5 flex items-center gap-5 group cursor-pointer hover:bg-primary/10 transition-all shadow-sm">
        <div className="w-14 h-14 rounded-2xl bg-primary text-black flex items-center justify-center shadow-lg group-hover:scale-110 transition-all">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold text-secondary uppercase tracking-tighter opacity-70">Tune for Alpha</p>
        </div>
      </div>
